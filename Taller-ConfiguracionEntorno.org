...
| *Comando* | *Descripción*                   | *Comando* | *Descripción*             |
|-----------+---------------------------------+-----------+---------------------------|
| ~C-x b~   | Cambiar entre buffers           | ~M-v~     | DDesplazarce hacia arriba |
| ~C-g~     | Cancela un comando en ejecucion |           |                           |
| ~C-l~     | Refrescar y centrar la pantalla |           |                           |
...
|                               |                                |             |
| Quillpangui Lozano Ana María  |anamaria.quillupangui@epn.edu.ec|colaborador  |
|-------------------------------+------------------------------+-------------- |
