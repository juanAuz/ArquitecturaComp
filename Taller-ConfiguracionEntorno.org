...
#+email: correo Emilio, juan.auzmontezuma@epn.edu.ec, Correo henry, anamaria.quillpangui@epn.edu.ec
#+language: Espanol
#+select_tags: export
...
último (o ultimos) cambios que fueron realizados
3. 
4. 

**Comandos Difíciles**
1. **Estudiante A:** <Poner el comando>. <Pegar lo que dice el primer párrafo de la ayuda>
2. **Estudiante B:Auz Montezuma Juan Diego** <Poner el comando>. <Pegar lo que dice el primer párrafo de la ayuda>
3.
