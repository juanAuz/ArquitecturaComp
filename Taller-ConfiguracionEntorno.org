...
#+email: emilio.alban@epn.edu.ec, juan.auzmontezuma@epn.edu.ec, henry.luisa@epn.edu.ec, anamaria.quillpangui@epn.edu.ec
#+language: Espanol
#+select_tags: export
...
| Nombre                       | email                           | Rol         |
|------------------------------+---------------------------------+-------------|
| Alban Salazar Emilio Fabian  | emilio.alban@epn.edu.ec         | líder       |
...
| Auz Montezuma Juan Diego     | juan.auzmontezuma@epn.edu.ec    | colaborador |
|                              |                                 |             |
|------------------------------+---------------------------------+-------------|
